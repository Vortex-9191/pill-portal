...
import {
  Search, MapPin, ChevronRight, ChevronDown, ChevronUp, Star, Heart, CheckCircle2, ArrowRight, AlertCircle, Smartphone, Map, Navigation, ShieldCheck, MessageCircle, Package
} from 'lucide-react'
...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-rose-50/30 font-zen-maru text-slate-800 pb-20 md:pb-0">
      {/* --- Hero Section --- */}
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center md:text-left space-y-7">
            ...
            <div className="bg-white p-2 rounded-2xl shadow-xl shadow-slate-100 max-w-md mx-auto md:mx-0 flex flex-col sm:flex-row gap-2 border border-slate-100">
              ...
              <Link href="/search" className="bg-rose-500 hover:bg-rose-600 text-white px-6 h-12 sm:h-14 rounded-xl font-bold flex items-center justify-center gap-2 transition shadow-lg shadow-rose-200 text-sm active:scale-95">
                <Search size={18} />
                検索
              </Link>
            </div>
      ...
      <section className="py-20 px-4 bg-slate-50/50">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex bg-white p-1.5 rounded-xl overflow-x-auto border border-slate-100 shadow-sm">
              {[
                ...
                <button
                  ...
                  className={`px-5 py-2 rounded-lg text-xs sm:text-sm font-bold whitespace-nowrap transition-all duration-200 ${activeTab === tab.id
                ...
                <div className="flex flex-col sm:flex-row gap-6 mt-2">
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex items-end justify-between pt-4 border-t border-dashed border-slate-100 mt-2">
                      ...
                      <Link href="/search" className="bg-slate-800 hover:bg-rose-500 text-white text-sm font-bold px-6 py-3 rounded-full transition-all shadow-lg shadow-slate-200 flex items-center gap-2 group-hover:shadow-rose-200 group-hover:translate-x-1">
          ...
          <div className="mt-10 text-center">
            <Link href="/search" className="text-slate-500 font-bold text-sm border-b border-slate-300 hover:border-slate-800 hover:text-slate-800 pb-1 transition">
              ランキングをもっと見る
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-4">
              ...
              <div key={idx} className="bg-slate-50 rounded-2xl p-6 border border-transparent hover:border-rose-100 hover:bg-rose-50/30 transition-colors">
                ...
                <div className="flex flex-wrap gap-2">
                  {group.prefs.map((pref, i) => (
                    <Link
                      key={i}
                      href={`/areas/${pref}`} // Note: Need to map pref name to slug if using slugs, but for now using name or need a mapper.
          ...
          <div className="mt-12 bg-gradient-to-r from-slate-800 to-slate-900 text-white p-8 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl shadow-slate-200 overflow-hidden relative">
            ...
            <Link href="/search" className="relative z-10 bg-white text-slate-900 font-bold px-8 py-4 rounded-full hover:bg-rose-50 hover:text-rose-600 transition shadow-lg whitespace-nowrap flex items-center gap-2 active:scale-95">
